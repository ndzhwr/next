...
export default ({ data }) => {
    ...
    console.log(process.env.API_URL, "Yoooooo")
        ...
        <>
            ...
            <div className="blogs px-[20vw]">
                <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-xl my-6 ">Cool blogs for you</span>
                    <button className="px-4 py-2 border-2 border-black font-semibold hover:opacity-70" onClick={() => router.push('/blogs/new')}> + New blog</button>
                </div>
                <hr />
